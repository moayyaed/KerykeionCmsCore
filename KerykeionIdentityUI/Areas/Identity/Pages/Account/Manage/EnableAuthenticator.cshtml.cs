...
namespace KerykeionIdentityUI.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var is2faTokenValid = await _userService.VerifyTwoFactorTokenAsync(
                user, _userService.IdentityOptions().Tokens.AuthenticatorTokenProvider, verificationCode);
            ...
            _logger.LogInformation("User with ID '{UserId}' has enabled 2FA with an authenticator app.", userId as string);

            StatusMessage = "Uw authenticator app is geverifieerd.";
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(dynamic user)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("KerykeionEncoder"),
