...
namespace KerykeionCms.Extensions
{
    ...
    {
        /// <summary>
        /// Adds Kerykeion Content management services using Sqlite to the application for the specified DbContext type, including a UI, also adds Identity services and UI.
        /// </summary>
        /// <remarks>
        /// Migrations and database still have to be made after calling this method.
        /// </remarks>
        /// <typeparam name="TContext">The type of the DbContext the KerykeionCms needs to work with.. Has to inherit from KerykeionCmsDbContext</typeparam>
        ...
        /// <summary>
        /// Adds Kerykeion Content management services using SqlServer to the application for the specified DbContext type, including a UI, also adds Identity services and UI.
        /// </summary>
        /// <remarks>
        /// Migrations and database still have to be made after calling this method.
        /// </remarks>
        ...
        /// <summary>
        /// Adds Kerykeion Content management services using SqlServer to the application for the specified User and DbContext types, including a UI, also adds Identity services and UI.
        /// </summary>
        /// <remarks>
        /// Migrations and database still have to be made after calling this method.
        /// </remarks>
        /// <typeparam name="TUser">The type of the User the KerykeionCms needs to work with.. Has to inherit from KerykeionUser</typeparam>
        /// <typeparam name="TContext">The type of the DbContext the KerykeionCms needs to work with.. Has to inherit from KerykeionCmsDbContext(TUser)</typeparam>
        /// <param name="services">Services to configure.</param>
        /// <param name="connectionString">The connectionstring of the Sql server database to work with.
        /// </param>
        /// <param name="confOpts">Configures the KerykeionCmsOptions. Optional parameter, defaults to null</param>
